...
export default function HomePage() {
  ...
  const { t } = useLanguage();
  // Apply gradient effect on mount
  useRandomGoldTextGradient('hero-title');
    ...
    <div className="container mx-auto px-4 py-8 space-y-16">
      ...
      <section className="text-center py-12 md:py-20">
        ...
        <div className="mb-8 flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button
            asChild
            size="lg"
            className="text-lg px-8 py-6 h-auto bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg hover:shadow-xl transition-all golden-shimmer-full"
          >
          ...
          <Button
            asChild
            size="lg"
            className="text-lg px-8 py-6 h-auto bg-[#E8C85A] text-white hover:bg-[#D4AF37] shadow-lg hover:shadow-xl transition-all"
          >
        ...
        <p className="text-sm text-muted-foreground">{t('home.wizardSubtitle')}</p>
            ...
            <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-4 items-end">
              ...
              <div className="w-full md:w-auto flex-shrink-0">
                <Button
                  type="submit"
                  size="lg"
                  className="w-full md:w-auto h-12 px-8 min-w-[120px]"
                >
      ...
      <section>
        {categoriesError ? (
          ...
          <div className="text-center py-12 text-muted-foreground">{t('services.noServices')}</div>
        )}
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {[1, 2, 3, 4].map(step => (
              <div key={step} className="text-center relative">
                ...
                <h3 className="font-semibold text-lg sm:text-xl mb-2 sm:mb-3 text-ivory">
                  {t(`home.steps.${step}.title`)}
                </h3>
                <p className="text-sm sm:text-base text-[#EDE8DA]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          <Card>
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground">{t('home.benefits.verified.desc')}</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground">{t('home.benefits.secure.desc')}</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground">{t('home.benefits.reviews.desc')}</p>
            </CardContent>
          </Card>
        </div>
      </section>

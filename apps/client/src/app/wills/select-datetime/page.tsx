...
export default function SelectDateTimePage() {
  ...
  if (error) {
    return (
      <div className="container mx-auto px-4 py-8">
        <ErrorDisplay error={error} onRetry={loadSchedule} title={t('wills.datetime.loadError')} />
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <p className="text-muted-foreground text-center mb-8">{t('wills.datetime.subtitle')}</p>
      ...
      <form onSubmit={handleSubmit}>
          ...
          <Card className="mt-6 border-none shadow-lg">
            <CardContent className="p-6">
              <div className="text-center space-y-2">
                <p className="text-sm text-muted-foreground">{t('wills.datetime.selected')}</p>
        ...
        <div className="mt-6 flex flex-col sm:flex-row gap-4">
          ...
          <Button type="submit" disabled={!selectedDate || !selectedTime} className="flex-1">

    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground">{t('wills.appointments.subtitle')}</p>
        </div>
        <Button asChild className="mt-4 sm:mt-0">
          <Link href="/wills/create">{t('wills.appointments.createNew')}</Link>
        </Button>
      </div>
      ...
      {filteredAndSortedAppointments.length === 0 ? (
        <div className="text-center py-12">
          <p className="text-muted-foreground mb-4">{t('wills.appointments.noAppointments')}</p>
          <Button asChild>
            <Link href="/wills/create">{t('wills.appointments.createNew')}</Link>
          </Button>
        </div>

...
describe('ServicesService', () => {
  ...
  describe('update', () => {
    ...
    it('should throw NotFoundException when service not found', async () => {
      ...
      // Act & Assert
      await expect(service.update(serviceId, userId, Role.VENDOR, dto)).rejects.toThrow(NotFoundException);
    });
    ...
    it('should throw ForbiddenException when user is not the service owner', async () => {
      ...
      // Act & Assert
      await expect(service.update(serviceId, userId, Role.VENDOR, dto)).rejects.toThrow(ForbiddenException);
    });
  });

...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create lawyer/notary profile (admin only)' }),
...
__decorate([
    ...
    (0, nest_keycloak_connect_1.Roles)({ roles: ['admin'] }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({ summary: 'List all lawyers/notaries (admin only)' }),
    (0, swagger_1.ApiQuery)({ name: 'status', enum: lawyer_notary_service_1.LawyerNotaryStatus, required: false }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get available lawyers by postal code (public)' }),
    (0, swagger_1.ApiQuery)({ name: 'postalCode', required: true }),
...
__decorate([
    (0, common_1.Get)('me'),
    (0, nest_keycloak_connect_1.Roles)({ roles: ['lawyer_notary', 'admin'] }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({ summary: 'Get my lawyer/notary profile' }),
...
__decorate([
    ...
    (0, nest_keycloak_connect_1.Public)(),
    (0, nest_keycloak_connect_1.Unprotected)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get lawyer/notary by ID (public)' }),
...
__decorate([
    ...
    (0, nest_keycloak_connect_1.Roles)({ roles: ['lawyer_notary', 'admin'] }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({ summary: 'Update my lawyer/notary profile' }),
    __param(0, (0, common_1.Request)()),
...
__decorate([
    ...
    (0, nest_keycloak_connect_1.Roles)({ roles: ['admin'] }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({ summary: 'Update lawyer/notary profile (admin only)' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, nest_keycloak_connect_1.Roles)({ roles: ['admin'] }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({ summary: 'Update lawyer/notary status (admin only)' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Lawyer/Notary ID' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, nest_keycloak_connect_1.Roles)({ roles: ['admin'] }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({ summary: 'Delete lawyer/notary profile (admin only)' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
...
exports.LawyerNotaryController = LawyerNotaryController = __decorate([
    (0, swagger_1.ApiTags)('lawyers-notaries'),
    (0, common_1.Controller)('lawyer-notary'),
    (0, nest_keycloak_connect_1.Resource)('lawyer-notary'),
